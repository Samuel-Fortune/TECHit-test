...
function techit_test_customize_preview_js() {
	wp_enqueue_script( 'techit-test-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), _S_VERSION, true );
}
